          ...
          child:Center(
            child: (
              Column(
                ...
                //Text(_CounterViewModel.counter.toString()),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                IconButton(onPressed:_CounterViewModel.counterSubFunction
                ,icon:Icon(Icons.horizontal_rule)),
                SizedBox(
                  height: 15
                ),
                IconButton(onPressed: _CounterViewModel.counterAddFunction
                ,icon:Icon(Icons.add))
                ],)
